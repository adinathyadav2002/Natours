...
var showAlert = exports.showAlert = function showAlert(type, mes) {
  var markup = "<div class='alert alert--".concat(type, "'>").concat(mes, "</div>");
...
exports.updateUserEmailName = void 0;
var _alerts = require("./alerts");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var updateUserEmailName = exports.updateUserEmailName = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? 'http://127.0.0.1:2000/api/v1/users/updateMe' : 'http://127.0.0.1:2000/api/v1/users/updatePassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
  ...
  return function updateUserEmailName(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
